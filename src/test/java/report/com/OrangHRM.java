...
public class OrangHRM {
	...
	public void f() {
		...
		try {
			...
			test.fail("Login was un-Successful : "+ e);
		}
		...
		try {
			...
			test.fail("Dashboradmethod was un-Successful : "+ e);
		}
	...
	public void beforeTest() {
		...
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("extentOrange.html");
